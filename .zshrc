...
alias grbm="git branch -r | grep -q 'origin/HEAD -> origin/main' && git pull origin main --rebase || git pull origin master --rebase"
...
alias gcod="git fetch origin develop && git checkout origin/develop"
alias gcom="git fetch origin; (git branch -r | grep -q 'origin/HEAD -> origin/main' && git checkout origin/main || git checkout origin/master)"
alias gd="git diff"
alias grs="git reset"
