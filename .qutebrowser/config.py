...
config.bind('esl', 'open -t https://docs.google.com/spreadsheets/d/1HsTu5QJVAqM9NWdZ2Sz8iIx9O7npha7l-WDEXA6XTm4/edit#gid=481443926')
...
config.bind('ezn', 'open -t https://zing.vn')
...
config.bind('Ezn', 'open https://zing.vn')
