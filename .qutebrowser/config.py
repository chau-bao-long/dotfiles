...
config.bind('ggh', 'open https://github.com')
config.bind('gsl', 'open https://docs.google.com/spreadsheets/u/1/d/1VjaXOycDguoesjVfVxx6uUSV_cssOHeDWZJDivTvLik/edit#gid=891834841')
config.bind('gst', 'open qute://settings/')
